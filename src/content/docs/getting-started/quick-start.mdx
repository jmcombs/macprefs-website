...
Copy the [Recommended Configuration Template](/getting-started/first-config/) from the First Config guide:
...
If you prefer to build from your raw export, follow the [Manual Curation Workflow](/guides/migration-curation/) guide for step-by-step guidance on identifying safe vs. ephemeral keys.
