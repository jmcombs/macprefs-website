...
<Aside type="tip">
Free tier shows Apple domains only. Pro+ unlocks third-party app domains.
</Aside>
...
<Aside type="note">
Free tier exports Apple domains only. Pro+ exports all domains including third-party apps.
</Aside>
...
<Aside type="caution">
Without `--yes`, Free tier will prompt for confirmation before applying changes.
</Aside>
